...
<head>
    ...
    <!-- ✅ Carga jQuery antes de cualquier otro script -->
    <script type="text/javascript" src="js/jquery/jquery-1.7.1.min.js"></script>
    <script type="text/javascript" src="js/jquery/jquery-ui-1.8.17.custom.min.js"></script>

    <!-- ✅ Carga jsPDF y sus plugins -->
...
<body>
    ...
    <!-- ✅ Asegurar que los scripts se ejecuten correctamente -->
    <script>
    ...
    <button id="evaluarBtn">Evaluar Seguridad</button>
    <button id="pdfBtn">Generar Comprobante PDF</button>
    <input type="hidden" id="respuestasUsuario">
